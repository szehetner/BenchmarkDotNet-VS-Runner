...
namespace BenchmarkRunner
{
    ...
    {
        /// <summary>
        /// BenchmarkTreeWindowPackage GUID string.
        /// </summary>
        public const string PackageGuidString = "64586e06-f692-4dd6-a3b2-289401b5149a";

        /// <summary>
        /// Initializes a new instance of the <see cref="BenchmarkTreeWindowPackage"/> class.
        /// </summary>
        public BenchmarkTreeWindowPackage()
        {
        ...
        protected override async Task InitializeAsync(CancellationToken cancellationToken, IProgress<ServiceProgressData> progress)
        {
            ...
            await BenchmarkTreeWindowCommand.InitializeAsync(this);
        }
